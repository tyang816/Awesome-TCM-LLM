...
- [*Pharmacological Research*] **TCMChat** 中药知识聊天机器人 [浙江大学] [[论文](https://doi.org/10.1016/j.phrs.2024.107530)] [[ScienceDirect](https://www.sciencedirect.com/science/article/pii/S1043661824004754)] [[代码](https://github.com/ZJUFanLab/TCMChat)] [[模型](https://huggingface.co/ZJUFanLab/TCMChat-600k)] [[数据集](https://huggingface.co/datasets/ZJUFanLab/TCMChat-dataset-600k)]
...
- [*Frontiers in Medicine*] **中医医案问答系统** 医案驱动的LLM中医问答系统 [安徽中医药大学] [[DOI](https://doi.org/10.3389/fmed.2024.1512329)]
...
- **MRD-RAG** 模拟临床推理的多轮诊断RAG框架，并构建覆盖中西医的**DiagnosGraph**（876病/7997节点/37201三元组） [[论文](https://arxiv.org/abs/2504.07724)]
...
- **From Metaphor to Mechanism** LLM解码中医隐喻/取象语言并映射现代医学概念 [[论文](https://arxiv.org/abs/2503.02760)]
...
- [*Methods of Information in Medicine*] **TCMSF** 中医证候古籍知识图谱构建框架 [[DOI](https://doi.org/10.1055/a-2590-6348)]
...
- **GPT-4 中医研究生考试评估** GPT-4 与国产主流大模型在中医研究生考试数据集上的表现评估（预印本） [[DOI](https://doi.org/10.21203/rs.3.rs-4392855/v1)]
- **RAG 增强中医问答置信度** 检索增强生成提升大模型中医问答置信度（预印本） [[DOI](https://doi.org/10.31219/osf.io/ns2v3)]
...
- [*IEEE BIBM*] **中医方剂 LLM 分类** 大语言模型驱动的中医方剂分类 [[DOI](https://doi.org/10.1109/BIBM58861.2023.10385776)]
