...
- [*Frontiers in Medicine*] **TCM-DiffRAG** Syndrome-differentiation RAG with a general KG, a personalized KG, and chain-of-thought. [[Paper](https://arxiv.org/abs/2602.22828)] [[Code](https://github.com/LiJianmin6706/Tcm_Diff_RAG)] [[Published](https://doi.org/10.3389/fmed.2026.1804478)]
...
- [*Frontiers in Medicine*] **TCM case-based QA system** Case-record-driven LLM question-answering system for TCM. [Anhui University of Chinese Medicine] [[DOI](https://doi.org/10.3389/fmed.2024.1512329)]
...
- **MRD-RAG** Multi-round diagnostic RAG simulating clinical reasoning; builds **DiagnosGraph** spanning TCM and Western medicine (876 diseases / 7,997 nodes / 37,201 triples). [[Paper](https://arxiv.org/abs/2504.07724)]
...
- **From Metaphor to Mechanism** LLMs decode TCM metaphor / imagistic-thinking language and map it to modern medical concepts. [[Paper](https://arxiv.org/abs/2503.02760)]
...
- [*Methods of Information in Medicine*] **TCMSF** Construction framework for a TCM syndrome ancient-book knowledge graph. [[DOI](https://doi.org/10.1055/a-2590-6348)]
...
- **GPT-4 中医研究生考试评估** GPT-4 vs mainstream Chinese LLMs on a TCM postgraduate examination dataset (preprint). [[DOI](https://doi.org/10.21203/rs.3.rs-4392855/v1)]
- **RAG 增强中医问答置信度** Implementing retrieval-augmented generation to build LLM confidence in TCM (preprint). [[DOI](https://doi.org/10.31219/osf.io/ns2v3)]
...
- [*IEEE BIBM*] **中医方剂 LLM 分类** TCM formula classification using large language models. [[DOI](https://doi.org/10.1109/BIBM58861.2023.10385776)]
